...
public class HomeActivity extends FragmentActivity implements
	...
	public class SectionsPagerAdapter extends FragmentPagerAdapter {
		...
		@Override
		public CharSequence getPageTitle(int position) {               //referring to title
	...
	public static class DummySectionFragment extends Fragment {
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container,
			...
			dummyTextView.setText(Integer.toString(getArguments().getInt(
					ARG_SECTION_NUMBER)));
			// setting the layout on different tabs
			if(getArguments().getInt(ARG_SECTION_NUMBER)==1){
				rootView=inflater.inflate(R.layout.introduction, container,false);
			}
			if(getArguments().getInt(ARG_SECTION_NUMBER)==2){
				rootView=inflater.inflate(R.layout.license, container,false);
			}
			return rootView;
		}
	}
	
	public void startClick(View v) {    //shows the workbench on clicking it
		Intent i;
		i=new Intent("com.example.emulator8051.ApplicationActivity");
		startActivity(i);
	}
	public void tourClick(View v){
		Intent i;
		i=new Intent("com.example.emulator8051.takeatourVideo");
		startActivity(i);
